...
class Preprocess(object):
    ...
    def remove_stop_words_and_punctuation(self,**kwargs):
        """ remove stopwords"""
    ...
    def get_lemmatization(self, final_sentence):
    ...
    def preprocess_with_lemma(self):
        # Formatting words, Removing Unwanted Characters, and Tokenization:
        tokens = self.get_tokens()
        # Expanding Contractions:
        expandedTokens = self.replace_contractions(tokens)
        # Get Part of Speech Tags:
        pos1 = self.get_pos_tag(tokens)
        # Remove Stop Words and Punctuation:
        pos = dict(pos=pos1)
        final_sentence = self.remove_stop_words_and_punctuation(**pos)
        #Lemmatize Tokens:
        res_lemma = self.get_lemmatization(final_sentence2)
